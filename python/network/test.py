...
for species1 in species_list:
  for species2 in species_list:
    ...
    print(f'./sana -fg1 ../PPI-Network-Alignment/networks/SANA/{species1.short_name.lower().replace(" ", "_")}.network-109-4.4.222.el -fg2 ../PPI-Network-Alignment/networks/SANA/{species2.short_name.lower().replace(" ", "_")}.network-109-4.4.222.el -ec 1.0 -o {species_short1}_{species_short2}')